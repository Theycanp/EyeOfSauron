...
DEFAULT_PROVIDER_REGISTRY = ProviderRegistry((
    ...
    ProviderSpec(
        ...
        (
            ...
            _field("entry_filter_profile", "string", default="",
                   description="Reviewed server-side retention profile for unusually noisy feeds."),
            _field("notification_eligible", "boolean", default=True,
                   description="Whether observations from this source may directly trigger notifications."),
        ),
        (),
        _READ_ONLY_FETCH,
    ),
