        ...
        for symbol in symbols:
            ...
            if newly_active and now_epoch - last_event >= cooldown:
                ...
                observations.append(Observation(
                    ...
                    attributes={"section": self.config.section, "symbol": symbol, "change_pct": round(change, 4), "gap_pct": round(gap, 4), "volume_ratio": round(volume_ratio, 4), "event_types": event_types},
                ))
                ...
                observations.append(Observation(
                    ...
                    attributes={"section": self.config.section, "symbol": symbol, "recovered": recovered},
                ))
